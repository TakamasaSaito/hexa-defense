...
目標バランス: 無強化・武器1個でW6〜7敗北(Node.jsシミュレーション確認済)

### シミュレーション結果(無強化・サブ砲台Lv1取得)
| W | 出現数 | 赤HP | 橙HP | 赤速 | 橙速 | 受ダメ | HP残 |
|---|---|---|---|---|---|---|---|
| W1 | 9 | 18 | 36 | 59 | 38 | 0 | 100 |
| W2 | 12 | 24 | 46 | 63 | 42 | 0 | 100 |
| W3 | 15 | 30 | 56 | 67 | 46 | 0 | 100 |
| W4 | 18 | 36 | 66 | 71 | 50 | 0 | 100 |
| W5 | BOSS | 42 | 76 | - | - | 36 | 64 ← 武器獲得 |
| W6 | 25 | 55 | 98 | 81 | 60 | 278 | **-194 敗北** |

W1~4: イントロ期。多数同時スポーン時に一部が塔に到達する場合があるが(ステップ実測でW1: 〜8DMG程度)、ウェーブクリア回復+20HPで吸収できる範囲。→ W5ボス撃破・武器獲得後にW6で敗北。設計意図どおり。
